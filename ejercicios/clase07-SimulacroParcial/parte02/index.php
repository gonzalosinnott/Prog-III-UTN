...
switch($method)
{
    case 'POST':
        switch ($option)
        {
            ...
            case 'ventaPizza':
                /*
                a- (1 pts.) AltaVenta.php: (por POST)se recibe el email del usuario y el sabor,tipo y cantidad ,si el ítem existe en Pizza.json, 
    ...
    case 'GET':
        switch ($option)
        {
            ...
            case 'cargaPizza':
                 /*
                (1 pt.) PizzaCarga.php: (por GET)se ingresa Sabor, precio, Tipo (“molde” o “piedra”), cantidad( de unidades). 
