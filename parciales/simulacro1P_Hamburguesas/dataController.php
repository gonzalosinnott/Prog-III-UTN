...
class DataController{
                ...
                if ($fileSelected != false) {
                    while (!feof($fileSelected)) {
                        ...
                        if ($_dataObtained != null) {
                            $product = new Hamburguesa($_dataObtained['id'], $_dataObtained['nombre'], $_dataObtained['precio'], $_dataObtained['tipo'], $_dataObtained['cantidad']);
                            array_push($hamburguesas, $product);
                        }
                    }
                }
                fclose($fileSelected);
    ...
    public static function guardarFoto($producto, $imagen, $email = "", $fecha = "", $pedidoNumero = "", $accion)
    {
        ...
        {
            case 'venta':                
                $nombreFoto = $fecha . "_" . $pedidoNumero . "_" . $producto->tipo . "_" . $producto->nombre . "_" . strtok($email, '@') . "_" .  ".jpg";
                $destino = ".\ImagenesDeLaVenta\\";
                break;
            case 'carga':
                $nombreFoto = $producto->getTipo() . "_" . $producto->getNombre() . ".jpg";
                $destino = ".\ImagenesDeHamburguesas\\"; 
                break;
            case 'devolucion':
